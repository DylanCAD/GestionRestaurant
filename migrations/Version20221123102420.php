 ...
 */
final class Version20221123102420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, commande_id INT NOT NULL, nom_cli VARCHAR(255) NOT NULL, prenom_cli VARCHAR(255) NOT NULL, rue_cli VARCHAR(255) NOT NULL, cp_cli VARCHAR(255) NOT NULL, ville_cli VARCHAR(255) NOT NULL, tel_cli VARCHAR(255) NOT NULL, INDEX IDX_C744045582EA2E54 (commande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE menu (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, nom_menu VARCHAR(255) NOT NULL, prix_menu DOUBLE PRECISION NOT NULL, image_menu VARCHAR(255) NOT NULL, description_menu VARCHAR(255) DEFAULT NULL, INDEX IDX_7D053A93C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
